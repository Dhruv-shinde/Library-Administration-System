...
void creditNclose(){
    ...
    printf("Programmer....");
    gotoxy(16,6);
    printf("Dhruv Sanjay Shinde");
    gotoxy(16,8);
    printf("E-mail: dhruvshinde1612@gmail.com");
    gotoxy(16,10);
    printf("Department of Electronics and Telecommunication");
    gotoxy(16,11);
    printf("Prof.Ram Meghe Institute Of Technology And Research ,Badnera ,Amravati");
    gotoxy(10,17);
